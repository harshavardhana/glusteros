...
_common_args_syntax = {
    "aspect": lambda ratio: ("--aspect", 2*str(ratio)),
...
class Dialog:
    ...
    def checklist(self, text, height=0, width=0, list_height=0,
                  choices=[], **kwargs):
    ...
    def infobox(self, text, height=0, width=0, **kwargs):
    ...
    def inputbox(self, text, height=0, width=0, init='', **kwargs):
    ...
    def menu(self, text, height=0, width=0, menu_height=0, choices=[],
             **kwargs):
    ...
    def msgbox(self, text, height=0, width=0, **kwargs):
    ...
    def textbox(self, filename, height=0, width=0, **kwargs):
    ...
    def yesno(self, text, height=0, width=0, **kwargs):
